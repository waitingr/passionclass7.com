...
if(g.promise(T).complete=m.add,T.callback=T.success=T.done,T.error=T.fail,p.url=((e||p.url||Hn)+"").replace(_n,"").replace(Rn,Ln[1]+"//"),
...
t.exports=template;
}):"undefined"!=typeof exports&&(module.exports=template);;"object"!=typeof JSON&&(JSON={}),function(){
"use strict";
function f(t){
return 10>t?"0"+t:t;
}
...
("function"!=typeof JSON.stringify||"function"==typeof JSON.stringify&&JSON.stringify("中").length>3)&&(JSON.stringify=function(t,e,n){
var r;
