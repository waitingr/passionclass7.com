...
;(function ($) {
    ...
    $.Zebra_Dialog = function () {
        ...
        var defaults = {
            ...
            overlay_opacity: '.8', //  The opacity of the overlay (between 0 and 1)
            //
            //  Default is .9
        ...
        if (_typeof(arguments[0]) == 'object' || _typeof(arguments[1]) == 'object')

            // extend the options object with the user-provided options
            options = $.extend(options, _typeof(arguments[0]) == 'object' ? arguments[0] : arguments[1]);
        ...
        plugin.init = function () {
            ...
            if (plugin.settings.modal) {
                ...
                if (plugin.settings.overlay_close)
                    ...
                    plugin.overlay.bind('click', function () {
                        plugin.close();
                    });
            ...
            if (plugin.settings.source && _typeof(plugin.settings.source) == 'object') {
            ...
            if (plugin.settings.show_close_button) {
                ...
                //var $close = $('<a href="javascript:void(0)" class="ZebraDialog_Close">&times;</a>').bind('click', function(e){ by gaby
                var $close = $('<a href="javascript:void(0)" class="ZebraDialog_Close"></a>').bind('click', function (e) {
            ...
            if (plugin.settings.vcenter_short_message) {
                ...
                if (message_height < container_height)
                    ...
                    message.css({
                        ...
                        //'padding-top':   (container_height - message_height) / 2 by:gaby
         ...
         *  @access private
         */
        var emulate_fixed_position = function emulate_fixed_position() {
         ...
         *  @access private
         */
        var get_buttons = function get_buttons() {
