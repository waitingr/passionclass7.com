...
var n="open.weixin.qq.com"==location.hostname?"https://res.wx.qq.com/":"/",t=function(e){
var n=e.lastIndexOf(".");
return n>=0?e.substring(n):"";
};
"undefined"!=typeof MODULES&&(n+="c/=");
var s=e.data.pathinfo={
".js":"open/zh_CN/htmledition/js/",
".css":"open/zh_CN/htmledition/res/css/"
};
e.config({
base:n,
map:[function(n){
var a=t(n),i=e.data.base,r=n.substr(i.length);
if("undefined"!=typeof MODULES&&MODULES[r]){
var c=MODULES[r],o=c;
return 0==o.indexOf("http://")||0==o.indexOf("https://")?o:(-1==o.indexOf(i.replace("/c/=",""))&&(o=i+c),
".js"!=a&&".css"!=a&&(o=o.replace("/c/=","")),o);
}
return i.replace("/c/=","")+s[a]+r+"?20130807";
}]
});
}(seajs);;